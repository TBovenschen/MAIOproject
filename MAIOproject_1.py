...
threshold_lon = 0.000005
threshold_lat = 0.0000005
...
for key in Data.keys():
    plt.scatter(Data[key]['lon'][:-1],Data[key]['lat'][:-1]) # Laatste punt is bijna altijd slecht omdat RollingStd wordt berekend tot eind-1 dus in plot ook alles tot eind-1
...
#Displacement  = {elem : pd.DataFrame for elem in NrJumps}
#for key in RollingMean.keys():
